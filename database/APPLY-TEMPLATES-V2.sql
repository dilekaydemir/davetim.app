-- =====================================================
-- TEMPLATES V2 - QUICK START (30 Şablon)
-- =====================================================
...
-- 3. Mevcut template'leri temizle
TRUNCATE TABLE templates CASCADE;

-- Sequence'i bul ve sıfırla
DO $$
DECLARE
  seq_name TEXT;
BEGIN
  -- templates tablosunun id kolonunun sequence'ini bul
...
-- 4. 30 Temel Şablon Ekle
-- =====================================================

-- DÜĞÜN (3 şablon: 1 FREE, 1 PRO, 1 PREMIUM)
...
-- Diğer kategoriler için benzer şekilde devam...
-- Bu dosya 30 şablon içerecek şekilde tamamlanacak

-- =====================================================
-- SONUÇ
-- =====================================================
SELECT 
  'Toplam ' || COUNT(*) || ' şablon eklendi' as summary,
